...
default, it draws circular memory and battery meters around a centered clock.
These only appear when you begin to enter your password -- the "empty" screen is
still solid black.
